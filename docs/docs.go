    ...
    "paths": {
        ...
        "/remind/day/remindbox/": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"msg\":\"success\", \"num\":数量, \"content\":数组，其中包含每个的id， 其中confirm是用来判断显示的内容是否带有小眼睛图标， 2为接受，3为拒绝，其中red_point字段是用来表示是否未读，即单条信息是否显示小红点}",
                        "schema": {
    ...
    "definitions": {
        ...
        "model.Requirements": {
            ...
            "properties": {
                ...
                "place": {
                    "description": "RequirePeopleNum int    ` + "`" + `gorm:\"require_people_num\" json:\"require_people_num\"` + "`" + `",
                    "type": "integer"
                },
                "post_time": {
                    "type": "string"
